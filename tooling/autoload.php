...
require_once __DIR__ . "/helper_functions/database_additional_pages.php";
require_once __DIR__ . "/helper_functions/database_products_images.php";
require_once __DIR__ . "/helper_functions/database_parameters.php";
require_once __DIR__ . "/helper_functions/database_categories.php";
...
require_once __DIR__ . "/helper_functions/cart.php";
