...
$pages = database_additional_pages_get($db);
$db->close();
        ...
        <div class="container mx-auto">
            <div class="flex flex-col gap-4 justify-center items-center max-w-3xl mx-auto">
                ...
                <div class="flex flex-row justify-end items-center w-full">
                    <a href="<?= base_url('/management/additional-pages/create.php') ?>"
                       class="px-8 py-2 bg-green-600 text-neutral-200 rounded-xl font-bold">Dodaj nową stronę</a>
                </div>
            </div>
        </div>
    <?php });
